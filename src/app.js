  ...
  _buildDOM() {
    ...
    document.getElementById('app').innerHTML = `
      ...
      <div class="modal" id="browserModal" style="max-width:100%; width:100%; height:100%; border-radius:0; border:none; padding:0; gap:0;">
        ...
        <iframe id="browserFrame" style="flex:1; width:100%; border:none; background:#0F0F12;" sandbox="allow-scripts allow-same-origin allow-forms allow-popups allow-modals"></iframe>
